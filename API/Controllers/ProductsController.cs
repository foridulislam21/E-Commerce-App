...
namespace API.Controllers
{
    public class ProductsController : BaseApiController
    {
            ...
            [FromQuery] ProductSpecParams productSpec)
        {
            ...
            var totalItems = await _productManager.CountAsync (countSpec);
            ...
            return Ok (new Pagination<ProductToReturnDto> (productSpec.PageIndex, productSpec.PageSize, totalItems, productsFromRepo));
        }
